...
class MainScene extends THREE.Scene {
    constructor(width, height)
    {
        ...
        this.cam = new THREE.PerspectiveCamera(60, width / height, 1.0, 1000.0);
    ...
    update(dt)
    {
        ...
        this.uniforms.uObjectA.value[0] = THREE.Math.lerp(0.2, 1.0, Math.abs(Math.sin(this.time))) ;
        this.uniforms.uObjectA.value[1] = THREE.Math.lerp(0.2, 0.0, Math.abs(Math.cos(this.time))) ;
        this.uniforms.uObjectA.value[2] = THREE.Math.lerp(0.2, 0.0, Math.abs(Math.sin(this.time))) ;
        this.uniforms.uObjectA.value[3] = Math.abs(Math.sin(this.time) * Math.sin(this.time)) * 1.25;

        this.uniforms.uObjectB.value[0] = THREE.Math.lerp(0.2, 1.0, Math.abs(Math.cos(this.time))) ;
        this.uniforms.uObjectB.value[1] = THREE.Math.lerp(0.2, 1.0, Math.abs(Math.sin(this.time))) ;
        this.uniforms.uObjectB.value[2] = THREE.Math.lerp(0.2, 0.0, Math.abs(Math.cos(this.time))) ;
        this.uniforms.uObjectB.value[3] = Math.abs(Math.sin(this.time) * Math.sin(this.time)) * 1.17;

        this.uniforms.uObjectC.value[0] = THREE.Math.lerp(0.2, 1.0, Math.abs(Math.sin(this.time))) ;
        this.uniforms.uObjectC.value[1] = THREE.Math.lerp(0.2, 0.0, Math.abs(Math.cos(this.time))) ;
        this.uniforms.uObjectC.value[2] = THREE.Math.lerp(0.2, 1.0, Math.abs(Math.sin(this.time))) ;
        this.uniforms.uObjectC.value[3] = Math.abs(Math.sin(this.time) * Math.sin(this.time)) * 1.17;

        this.uniforms.uObjectD.value[0] = THREE.Math.lerp(0.2, 0.0, Math.abs(Math.cos(this.time))) ;
        this.uniforms.uObjectD.value[1] = THREE.Math.lerp(0.2, 0.0, Math.abs(Math.sin(this.time))) ;
        this.uniforms.uObjectD.value[2] = THREE.Math.lerp(0.2, 1.0, Math.abs(Math.cos(this.time))) ;
        this.uniforms.uObjectD.value[3] = Math.abs(Math.sin(this.time) * Math.sin(this.time)) * 1.3;

        this.uniforms.uObjectE.value[0] = THREE.Math.lerp(0.2, 0.0, Math.abs(Math.sin(this.time)));
        this.uniforms.uObjectE.value[1] = THREE.Math.lerp(0.2, 1.0, Math.abs(Math.cos(this.time)));
        this.uniforms.uObjectE.value[2] = THREE.Math.lerp(0.2, 1.0, Math.abs(Math.sin(this.time)));
        this.uniforms.uObjectE.value[3] = Math.abs(Math.sin(this.time) * Math.sin(this.time)) * 1.3;

        this.uniforms.uObjectF.value[0] = THREE.Math.lerp(0.2, 0.0, Math.abs(Math.cos(this.time)));
        this.uniforms.uObjectF.value[1] = THREE.Math.lerp(0.2, 1.0, Math.abs(Math.sin(this.time)));
        this.uniforms.uObjectF.value[2] = THREE.Math.lerp(0.2, 0.0, Math.abs(Math.cos(this.time)));
        this.uniforms.uObjectF.value[3] = Math.abs(Math.sin(this.time) * Math.sin(this.time)) * 1.0;
...
{
    this.dom = document.getElementById("profile-canvas");
